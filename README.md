<h1>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/images/nf-core-radseq_logo_dark.png">
    <img alt="nf-core/radseq" src="docs/images/nf-core-radseq_logo_light.png">
  </picture>
</h1>[![GitHub Actions CI Status](https://github.com/nf-core/radseq/actions/workflows/ci.yml/badge.svg)](https://github.com/nf-core/radseq/actions/workflows/ci.yml)
...
<!-- If you use nf-core/radseq for your analysis, please cite it using the following doi: [10.5281/zenodo.XXXXXX](https://doi.org/10.5281/zenodo.XXXXXX) --><!-- TODO nf-core: Add bibliography of tools and data used in your pipeline -->
