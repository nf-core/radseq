...
6. Index, merge and index alignments ([`SAMtools`](https://github.com/samtools/samtools))

7. Construct intervals for freebayes ([`BEDtools`](https://bedtools.readthedocs.io/en/latest/))

8. Variant calling ([`FreeBayes`](https://github.com/freebayes/freebayes))
